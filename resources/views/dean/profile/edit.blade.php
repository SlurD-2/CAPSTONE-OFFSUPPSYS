            ...
            <div class="bg-white rounded-md">
                ...
                <div class="profile-container">
                    <div class="max-w-7xl">
                        <div>
                            <div class="max-w-xl">
                                @include('dean.profile.partials.update-profile-information-form')
                            </div>
                        </div>
                   
                        <div>
                            <div class="max-w-xl">
                                @include('dean.profile.partials.update-password-form')
                            </div>
                        </div>

                        <div>
                            <div class="max-w-xl">
                                @include('dean.profile.partials.delete-user-form')
                            </div>
                        </div>
                    </div>
                </div>
